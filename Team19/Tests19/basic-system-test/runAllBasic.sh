...
if [ -f "$FILE" ]; then
	../../Code19/build_win/x86-Debug/src/autotester/autotester.exe ./basicFullSimple_source.txt ./Affects_query.txt ./Affects_out.xml
	../../Code19/build_win/x86-Debug/src/autotester/autotester.exe ./basicFullSimple_source.txt ./AffectsStar_query.txt ./AffectsStar_out.xml
	...
	../../Code19/build_win/x86-Debug/src/autotester/autotester.exe ./basicFullSimple_source.txt ./Modifies_query.txt ./Modifies_out.xml
	../../Code19/build_win/x86-Debug/src/autotester/autotester.exe ./basicFullSimple_source.txt ./MultiClause_query.txt ./MultiClause_out.xml
	...
	../../Code19/build_win/x86-Debug/src/autotester/autotester.exe ./basicFullSimple_source.txt ./NoClause_query.txt ./NoClause_out.xml
	...
	../../Code19/build_win/x86-Debug/src/autotester/autotester.exe ./basicFullSimple_source.txt ./Uses_query.txt ./Uses_out.xml
else
