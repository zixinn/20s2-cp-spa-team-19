...
if exist ..\..\Code19\build_win\x86-Debug\src\autotester\autotester.exe (
	...
	..\..\Code19\build_win\x86-Debug\src\autotester\autotester.exe Source.txt Tuples_query.txt Tuples_out.xml
	..\..\Code19\build_win\x86-Debug\src\autotester\autotester.exe Source.txt With_query.txt With_out.xml
) else (
	...
	%id% Source.txt With_query.txt With_out.xml
) 
