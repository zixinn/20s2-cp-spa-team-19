...
if [ -f "$FILE" ]; then
	...
	../../Code19/cmake-build-debug/src/autotester/autotester complexFullSimple_source.txt NextBipStar_query.txt NextBipStar_out.xml
	../../Code19/cmake-build-debug/src/autotester/autotester complexFullSimple_source.txt AffectsBip_query.txt AffectsBip_out.xml
	../../Code19/cmake-build-debug/src/autotester/autotester complexFullSimple_source.txt AffectsBipStar_query.txt AffectsBipStar_out.xml
else
