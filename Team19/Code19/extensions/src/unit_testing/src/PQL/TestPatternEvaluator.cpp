...
TEST_CASE("PatternEvaluator evaluate stmt Name Underscore") {
    ...
    bool result1 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"\"x\"", "_"}, {"a"}, 1), tempResults1);
    ...
    bool result2 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"\"y\"", "_"}, {"a"}, 1), tempResults2);
...
TEST_CASE("PatternEvaluator evaluate stmt Name Name") {
    ...
    // a("x", "y")
    unordered_map<STRING, vector<int>> tempResults2;
    bool result2 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"\"x\"", "\"y\""}, {"a"}, 2), tempResults2);
    unordered_set<int> actual2(tempResults2["a"].begin(), tempResults2["a"].end());
    ...
    // a("x", "z")
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"\"x\"", "\"z\""}, {"a"}, 2), tempResults1);
    unordered_set<int> actual1(tempResults1["a"].begin(), tempResults1["a"].end());
...
TEST_CASE("PatternEvaluator evaluate stmt Name Expression") {
    ...
    // a("urgh", "3 * ((2 - 4) / w)")
    unordered_map<STRING, vector<int>> tempResults2;
    bool result2 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"\"urgh\"", "\"3 * ((2 - 4) / w)\""}, {"a"}, 2), tempResults2);
    unordered_set<int> actual2(tempResults2["a"].begin(), tempResults2["a"].end());
    ...
    // a("x", "x * y")
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"\"x\"", "\"x * y\""}, {"a"}, 2), tempResults1);
    unordered_set<int> actual1(tempResults1["a"].begin(), tempResults1["a"].end());
    unordered_set<int> expected1{};
    REQUIRE(actual1 == expected1);
    REQUIRE_FALSE(result1);
...
TEST_CASE("PatternEvaluator evaluate stmt Name ExpressionWithUnderscore") {
    ...
    // a("urgh", _"3 * ((2 - 4) / w)"_)
    unordered_map<STRING, vector<int>> tempResults2;
    bool result2 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"\"urgh\"", "_\"3 * ((2 - 4) / w)\"_"}, {"a"}, 2), tempResults2);
    unordered_set<int> actual2(tempResults2["a"].begin(), tempResults2["a"].end());
    unordered_set<int> expected2{ 3 };
    REQUIRE(actual2 == expected2);
    REQUIRE(result2);
    ...
    bool result3 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"\"cenX\"", "_\"2 - 4\"_"}, {"a"}, 2), tempResults3);
    ...
    bool result4 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"\"t\"", "_\"y\"_"}, {"a"}, 2), tempResults4);
    ...
    // a("x", "v + z * t")
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"\"x\"", "\"v + z * t\""}, {"a"}, 2), tempResults1);
    unordered_set<int> actual1(tempResults1["a"].begin(), tempResults1["a"].end());
    unordered_set<int> expected1{};
    REQUIRE(actual1 == expected1);
    REQUIRE_FALSE(result1);
...
TEST_CASE("PatternEvaluator evaluate Variable Underscore (assignment stmts exists)") {
    ...
    // a(x, _)
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"a", VARIABLE_}, {"x", VARIABLE_} }, Clause("a", vector<STRING>{"x", "_"}, {"a", "x"}, 0), tempResults1);
    unordered_set<int> actual1(tempResults1["a"].begin(), tempResults1["a"].end());
...
TEST_CASE("PatternEvaluator evaluate stmt Variable Name") {
    ...
    // a(v, "y")
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"a", VARIABLE_}, {"v", VARIABLE_} }, Clause("a", vector<STRING>{"v", "\"y\""}, {"a", "v"}, 1), tempResults1);
    unordered_set<int> actual1(tempResults1["a"].begin(), tempResults1["a"].end());
    ...
    // a(v, "v")
    unordered_map<STRING, vector<int>> tempResults2;
    bool result2 = PatternEvaluator::evaluate({ {"a", VARIABLE_}, {"v", VARIABLE_} }, Clause("a", vector<STRING>{"v", "\"v\""}, {"a", "v"}, 1), tempResults2);
...
TEST_CASE("PatternEvaluator evaluate stmt Variable expression") {
    ...
    // a(v, "3 * 4 + (2 - 4)")
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"a", VARIABLE_}, {"v", VARIABLE_} }, Clause("a", vector<STRING>{"v", "\"3 * 4 + (2 - 4)\""}, {"a", "v"}, 1), tempResults1);
    unordered_set<int> actual1(tempResults1["a"].begin(), tempResults1["a"].end());
    unordered_set<int> actual2(tempResults1["v"].begin(), tempResults1["v"].end());
    ...
    // a(v, "3 * 4")
    unordered_map<STRING, vector<int>> tempResults2;
    bool result2 = PatternEvaluator::evaluate({ {"a", VARIABLE_}, {"v", VARIABLE_} }, Clause("a", vector<STRING>{"v", "\"3 * 4\""}, {"a", "v"}, 1), tempResults2);
    unordered_set<int> actual3(tempResults2["a"].begin(), tempResults2["a"].end());
    unordered_set<int> actual4(tempResults2["v"].begin(), tempResults2["v"].end());
    unordered_set<int> expected3{};
    unordered_set<int> expected4{};
...
TEST_CASE("PatternEvaluator evaluate stmt Variable ExpressionWithUnderscore") {
    ...
    // a(v, _"3 * 4 + (2 - 4)"_)
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"a", VARIABLE_}, {"v", VARIABLE_} }, Clause("a", vector<STRING>{"v", "_\"3 * 4 + (2 - 4)\"_"}, {"a", "v"}, 1), tempResults1);
    unordered_set<int> actual1(tempResults1["a"].begin(), tempResults1["a"].end());
    unordered_set<int> actual2(tempResults1["v"].begin(), tempResults1["v"].end());
    unordered_set<int> expected1{ 2 };
    unordered_set<int> expected2{ 5 };
    ...
    // a(v, _"3 * 4"_)
    unordered_map<STRING, vector<int>> tempResults2;
    bool result2 = PatternEvaluator::evaluate({ {"a", VARIABLE_}, {"v", VARIABLE_} }, Clause("a", vector<STRING>{"v", "_\"3 * 4\"_"}, {"a", "v"}, 1), tempResults2);
    unordered_set<int> actual3(tempResults2["a"].begin(), tempResults2["a"].end());
    unordered_set<int> actual4(tempResults2["v"].begin(), tempResults2["v"].end());
    unordered_set<int> expected3{ 2 };
    ...
    // a(v, _"4 / w"_)
    unordered_map<STRING, vector<int>> tempResults3;
    bool result3 = PatternEvaluator::evaluate({ {"a", VARIABLE_}, {"v", VARIABLE_} }, Clause("a", vector<STRING>{"v", "_\"4 / w\"_"}, {"a", "v"}, 1), tempResults3);
    ...
    // a(v, _"y"_)
    unordered_map<STRING, vector<int>> tempResults4;
    bool result5 = PatternEvaluator::evaluate({ {"a", VARIABLE_},  {"v", VARIABLE_}}, Clause("a", vector<STRING>{"v", "_\"y\"_"}, {"a", "v"}, 1), tempResults4);
...
TEST_CASE("PatternEvaluator evaluate stmt Underscore Underscore (assignment stmt exists)") {
    ...
    // a(_, _)
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"a", VARIABLE_}}, Clause("a", vector<STRING>{"_", "_"}, {"a"}, 0), tempResults1);
    unordered_set<int> actual1(tempResults1["a"].begin(), tempResults1["a"].end());
    unordered_set<int> expected1{ 1, 2, 3, 7, 21, 22};
    REQUIRE(actual1 == expected1);
    REQUIRE(result1);
...
TEST_CASE("PatternEvaluator evaluate stmt Underscore Name") {
    ...
    // a(_, "y")
    unordered_map<STRING, vector<int>> tempResults2;
    bool result2 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"_", "\"y\""}, {"a"}, 1), tempResults2);
    unordered_set<int> actual2(tempResults2["a"].begin(), tempResults2["a"].end());
    ...
    // a(_, "z")
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"_", "\"z\""}, {"a"}, 1), tempResults1);
    unordered_set<int> actual1(tempResults1["a"].begin(), tempResults1["a"].end());
    unordered_set<int> expected1{};
    REQUIRE(actual1 == expected1);
    REQUIRE_FALSE(result1);
...
TEST_CASE("PatternEvaluator evaluate stmt Underscore expression") {
    ...
    // a(_, "y")
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"_", "\"y\""}, {"a"}, 1), tempResults1);
    unordered_set<int> actual1(tempResults1["a"].begin(), tempResults1["a"].end());
    unordered_set<int> expected1{ 7, 21 };
    REQUIRE(actual1 == expected1);
    REQUIRE(result1);
    ...
    // a(_, "3 * 4")
    unordered_map<STRING, vector<int>> tempResults2;
    bool result2 = PatternEvaluator::evaluate({ {"a", VARIABLE_}}, Clause("a", vector<STRING>{"_", "\"3 * 4\""}, {"a"}, 1), tempResults2);
    unordered_set<int> actual2(tempResults2["a"].begin(), tempResults2["a"].end());
    unordered_set<int> expected2{};
    REQUIRE(actual2 == expected2);
    REQUIRE_FALSE(result2);
    ...
    // a(_, "3 * ((2 - 4) / w)")
    unordered_map<STRING, vector<int>> tempResults3;
    bool result3 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"_", "\"3 * ((2 - 4) / w)\""}, {"a"}, 1), tempResults3);
    unordered_set<int> actual3(tempResults3["a"].begin(), tempResults3["a"].end());
...
TEST_CASE("PatternEvaluator evaluate stmt Underscore ExpressionWithUnderscore") {
    ...
    // a(_, _"y"_)
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"_", "_\"y\"_"}, {"a"}, 1), tempResults1);
    unordered_set<int> actual1(tempResults1["a"].begin(), tempResults1["a"].end());
    ...
    // a(_, _"3 / w"_)
    unordered_map<STRING, vector<int>> tempResults2;
    bool result2 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"_", "_\"3 / w\"_"}, {"a"}, 1), tempResults2);
    unordered_set<int> actual2(tempResults2["a"].begin(), tempResults2["a"].end());
    unordered_set<int> expected2{};
    REQUIRE(actual2 == expected2);
    REQUIRE_FALSE(result2);
    ...
    // a(_, _"(2 - 4) / w"_)
    unordered_map<STRING, vector<int>> tempResults3;
    bool result3 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"_", "_\"(2 - 4) / w\"_"}, {"a"}, 1), tempResults3);
    unordered_set<int> actual3(tempResults3["a"].begin(), tempResults3["a"].end());
    unordered_set<int> expected3{ 3 };
    REQUIRE(actual3 == expected3);
    REQUIRE(result3);
...
TEST_CASE("PatternEvaluator evaluate stmt underscore subSTRING (edge case)") {
    ...
    // a(_, _"1"_)
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"a", VARIABLE_} }, Clause("a", vector<STRING>{"_", "_\"1\"_"}, {"a"}, 1), tempResults1);
    unordered_set<int> actual1(tempResults1["a"].begin(), tempResults1["a"].end());
    unordered_set<int> expected1{};
    REQUIRE(actual1 == expected1);
    REQUIRE_FALSE(result1);
...
TEST_CASE("PatternEvalautor evalaute if stmt synonym underscore underscore") {
    ...
    // ifs(v,_,_)
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"v", VARIABLE_}, {"ifs", IF_} }, Clause("ifs", vector<STRING>{"v", "_", "_"}, {"ifs", "v"}, 0), tempResults1);
    ...
    DesignExtractor::signalReset();
    unordered_map<STRING, vector<int>> tempResults2;
    bool result2 = PatternEvaluator::evaluate({ {"v", VARIABLE_}, {"ifs", IF_} }, Clause("ifs", vector<STRING>{"v", "_", "_"}, {"ifs", "v"}, 0), tempResults2);
...
TEST_CASE("PatternEvalautor evalaute if stmt underscore underscore underscore") {
    ...
    // ifs(_,_,_)
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"ifs", IF_} }, Clause("ifs", vector<STRING>{"_", "_", "_"}, {"ifs"}, 0), tempResults1);
    ...
    DesignExtractor::signalReset();
    unordered_map<STRING, vector<int>> tempResults2;
    bool result2 = PatternEvaluator::evaluate({ {"ifs", IF_} }, Clause("ifs", vector<STRING>{"_", "_", "_"}, {"ifs"}, 0), tempResults2);
    unordered_set<int> actual2(tempResults2["ifs"].begin(), tempResults2["ifs"].end());
    unordered_set<int> expected2{};
    REQUIRE(actual2 == expected2);
    REQUIRE_FALSE(result2);
...
TEST_CASE("PatternEvalautor evalaute if stmt name underscore underscore") {
    ...
    // ifs("x",_,_)
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"ifs", IF_} }, Clause("ifs", vector<STRING>{"\"x\"", "_", "_"}, {"ifs"}, 1), tempResults1);
    unordered_set<int> actual1(tempResults1["ifs"].begin(), tempResults1["ifs"].end());
    ...
    // ifs("urgh",_,_)
    unordered_map<STRING, vector<int>> tempResults2;
    bool result2 = PatternEvaluator::evaluate({ {"ifs", IF_} }, Clause("ifs", vector<STRING>{"\"urgh\"", "_", "_"}, {"ifs"}, 1), tempResults2);
    unordered_set<int> actual2(tempResults2["ifs"].begin(), tempResults2["ifs"].end());
    ...
    // ifs("cenX",_,_)
    unordered_map<STRING, vector<int>> tempResults3;
    bool result3 = PatternEvaluator::evaluate({ {"ifs", IF_} }, Clause("ifs", vector<STRING>{"\"cenX\"", "_", "_"}, {"ifs"}, 1), tempResults3);
...
TEST_CASE("PatternEvalautor evalaute while stmt synonym underscore") {
    ...
    // w(v,_)
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"v", VARIABLE_}, {"w", WHILE_} }, Clause("w", vector<STRING>{"v", "_"}, {"w", "v"}, 0), tempResults1);
    unordered_set<int> actual11(tempResults1["v"].begin(), tempResults1["v"].end());
    ...
    DesignExtractor::signalReset();
    unordered_map<STRING, vector<int>> tempResults2;
    bool result2 = PatternEvaluator::evaluate({ {"v", VARIABLE_}, {"w",	WHILE_} }, Clause("w", vector<STRING>{"v", "_"}, {"w", "v"}, 0), tempResults2);
...
TEST_CASE("PatternEvalautor evalaute while stmt underscore underscore") {
    ...
    // w(_, _)
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"w", WHILE_} }, Clause("w", vector<STRING>{"_", "_"}, {"w"}, 0), tempResults1);
    ...
    DesignExtractor::signalReset();
    unordered_map<STRING, vector<int>> tempResults2;
    bool result2 = PatternEvaluator::evaluate({ {"w", WHILE_} }, Clause("w", vector<STRING>{"_", "_"}, {"w"}, 0), tempResults2);
    unordered_set<int> actual2(tempResults2["w"].begin(), tempResults2["w"].end());
    unordered_set<int> expected2{};
    REQUIRE(actual2 == expected2);
    REQUIRE_FALSE(result2);
...
TEST_CASE("PatternEvalautor evalaute while stmt name underscore") {
    ...
    // w("w", _)
    unordered_map<STRING, vector<int>> tempResults1;
    bool result1 = PatternEvaluator::evaluate({ {"w", WHILE_} }, Clause("w", vector<STRING>{"\"w\"", "_"}, {"w"}, 1), tempResults1);
    unordered_set<int> actual1(tempResults1["w"].begin(), tempResults1["w"].end());
    ...
    // w("z",_)
    unordered_map<STRING, vector<int>> tempResults2;
    bool result2 = PatternEvaluator::evaluate({ {"w", WHILE_} }, Clause("w", vector<STRING>{"\"z\"", "_"}, {"w"}, 1), tempResults2);
    unordered_set<int> actual2(tempResults2["w"].begin(), tempResults2["w"].end());
    unordered_set<int> expected2{ 3 };
    REQUIRE(actual2 == expected2);
    REQUIRE(result2);
    ...
    // w("y",_)
    unordered_map<STRING, vector<int>> tempResults3;
    bool result3 = PatternEvaluator::evaluate({ {"w", WHILE_} }, Clause("w", vector<STRING>{"\"y\"", "_"}, {"w"}, 1), tempResults3);
    ...
    // w("x", _)
    unordered_map<STRING, vector<int>> tempResults4;
    bool result4 = PatternEvaluator::evaluate({ {"w", WHILE_} }, Clause("w", vector<STRING>{"\"x\"", "_"}, {"w"}, 1), tempResults4);
