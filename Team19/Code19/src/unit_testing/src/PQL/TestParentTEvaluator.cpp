...
TEST_CASE("ParentTEvaluator evaluate known synonym") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = ParentTEvaluator::evaluate({ {"w", WHILE_} }, Clause("Parent*", vector<string>{"4", "w"}), tempResults1);
    unordered_map<string, vector<int>> expected1 = { {"w", vector<int>{6}} };
    REQUIRE(b1);
    REQUIRE(tempResults1 == expected1);

    unordered_map<string, vector<int>> tempResults2;
    bool b2 = ParentTEvaluator::evaluate({ {"a", ASSIGN_} }, Clause("Parent*", vector<string>{"10", "a"}), tempResults2);
    ...
    unordered_map<string, vector<int>> tempResults3;
    bool b3 = ParentTEvaluator::evaluate({ {"c", CALL_} }, Clause("Parent*", vector<string>{"13", "c"}), tempResults3);
    unordered_map<string, vector<int>> expected3 = {};
    REQUIRE_FALSE(b3);
    REQUIRE(tempResults3 == expected3);
}
...
TEST_CASE("ParentTEvaluator evaluate synonym known") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = ParentTEvaluator::evaluate({ {"w", WHILE_} }, Clause("Parent*", vector<string>{"w", "7"}), tempResults1);
    ...
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = ParentTEvaluator::evaluate({ {"w", WHILE_} }, Clause("Parent*", vector<string>{"w", "14"}), tempResults2);
    ...
    unordered_map<string, vector<int>> tempResults3;
    bool b3 = ParentTEvaluator::evaluate({ {"ifs", IF_} }, Clause("Parent*", vector<string>{"ifs", "5"}), tempResults3);
    unordered_map<string, vector<int>> expected3 = {};
    REQUIRE_FALSE(b3);
    REQUIRE(tempResults3 == expected3);
}
...
TEST_CASE("ParentTEvaluator evaluate synonym synonym") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = ParentTEvaluator::evaluate({ {"ifs", IF_}, {"c", CALL_} }, Clause("Parent*", vector<string>{"ifs", "c"}), tempResults1);
    ...
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = ParentTEvaluator::evaluate({ {"ifs", IF_}, {"r", READ_} }, Clause("Parent*", vector<string>{"ifs", "r"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("ParentTEvaluator evaluate synonym underscore") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = ParentTEvaluator::evaluate({ {"w", WHILE_} }, Clause("Parent*", vector<string>{"w", "_"}), tempResults1);
    unordered_set<int> actual1(tempResults1["w"].begin(), tempResults1["w"].end());
    ...
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = ParentTEvaluator::evaluate({ {"r", READ_} }, Clause("Parent*", vector<string>{"r", "_"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("ParentTEvaluator evaluate underscore synonym") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = ParentTEvaluator::evaluate({ {"a", ASSIGN_} }, Clause("Parent*", vector<string>{"_", "a"}), tempResults1);
    ...
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = ParentTEvaluator::evaluate({ {"r", READ_} }, Clause("Parent*", vector<string>{"_", "r"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
