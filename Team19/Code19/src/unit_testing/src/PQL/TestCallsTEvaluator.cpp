...
TEST_CASE("CallsTEvaluator evaluate known synonym") {
    ...
    // Calls* ("proc4", p)
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = CallsTEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls*", vector<string>{"\"proc4\"", "p"}, {"p"}), tempResults1);
    ...
    // Calls* ("proc3", p)
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = CallsTEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls*", vector<string>{"\"proc3\"", "p"}, {"p"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = { };
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("CallsTEvaluator evaluate synonym known") {
    ...
    // Calls* (p, "proc7")
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = CallsTEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls*", vector<string>{"p", "\"proc7\""}, {"p"}), tempResults1);
    unordered_set<int> actual1(tempResults1["p"].begin(), tempResults1["p"].end());
    ...
    // Calls* (p, "proc4")
    unordered_map<string, vector<int>> tempResults3;
    bool b3 = CallsTEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls*", vector<string>{"p", "\"proc4\""}, {"p"}), tempResults3);
    unordered_map<string, vector<int>> expected3 = { };
    REQUIRE_FALSE(b3);
    REQUIRE(tempResults3 == expected3);
}
...
TEST_CASE("CallsTEvaluator evaluate synonym synonym") {
    ...
    // Calls* (p, p1)
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = CallsTEvaluator::evaluate({ {"p", PROCEDURE_}, {"p1", PROCEDURE_} }, Clause("Calls*", vector<string>{"p", "p1"}, {"p", "p1"}), tempResults1);
...
TEST_CASE("CallsTEvaluator evaluate underscore synonym") {
    ...
    // Calls* (_, p)
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = CallsTEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls*", vector<string>{"_", "p"}, {"p"}), tempResults1);
    unordered_set<int> actual1(tempResults1["p"].begin(), tempResults1["p"].end());
    ...
    // Calls* (_, p)
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = CallsTEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls*", vector<string>{"_", "p"}, {"p"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = { };
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("CallsTEvaluator evaluate synonym underscore") {
    ...
    // Calls* (p, _)
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = CallsTEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls*", vector<string>{"p", "_"}, {"p"}), tempResults1);
    unordered_set<int> actual1(tempResults1["p"].begin(), tempResults1["p"].end());
    ...
    // Calls* (p, _)
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = CallsTEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls*", vector<string>{"p", "_"}, {"p"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = { };
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
