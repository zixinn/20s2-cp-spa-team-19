...
TEST_CASE("AffectsTEvaluator evaluate known synonym") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsTEvaluator::evaluate({{"a", ASSIGN_}}, Clause("Affects*", vector<string>{"6", "a"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"a", vector<int>{9, 10}}};
    ...
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsTEvaluator::evaluate({{"n", PROGLINE_}}, Clause("Affects*", vector<string>{"3", "n"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {{"n", vector<int>{5}}};
    REQUIRE(b2);
    REQUIRE(tempResults2 == expected2);

    unordered_map<string, vector<int>> tempResults3;
    bool b3 = AffectsTEvaluator::evaluate({{"s", STMT_}}, Clause("Affects*", vector<string>{"4", "s"}), tempResults3);
...
TEST_CASE("AffectsTEvaluator evaluate synonym known") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsTEvaluator::evaluate({{"a", ASSIGN_}}, Clause("Affects*", vector<string>{"a", "11"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"a", vector<int>{7, 9}}};
    ...
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsTEvaluator::evaluate({{"s", STMT_}}, Clause("Affects*", vector<string>{"s", "6"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("AffectsTEvaluator evaluate synonym synonym") {
    setupAffectsT();
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsTEvaluator::evaluate({{"a", ASSIGN_}, {"n", PROGLINE_}}, Clause("Affects*", vector<string>{"a", "n"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"a", vector<int>{2, 2, 3, 6, 6, 6, 7, 9}}, {"n", vector<int>{3, 5, 5, 9, 10, 11, 11, 11}}};
    ...
    setupAffectsT2();
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsTEvaluator::evaluate({{"a1", ASSIGN_}, {"a2", ASSIGN_}}, Clause("Affects*", vector<string>{"a1", "a2"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("AffectsTEvaluator evaluate synonym underscore") {
    setupAffectsT();
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsTEvaluator::evaluate({{"s", STMT_}}, Clause("Affects*", vector<string>{"s", "_"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"s", vector<int>{2, 3, 6, 7, 9}}};
    ...
    setupAffectsT2();
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsTEvaluator::evaluate({{"a", ASSIGN_}}, Clause("Affects*", vector<string>{"a", "_"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("AffectsTEvaluator evaluate underscore synonym") {
    setupAffectsT();
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsTEvaluator::evaluate({{"a", ASSIGN_}}, Clause("Affects*", vector<string>{"_", "a"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"a", vector<int>{3, 5, 9, 10, 11}}};
    ...
    setupAffectsT2();
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsTEvaluator::evaluate({{"n", PROGLINE_}}, Clause("Affects*", vector<string>{"_", "n"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
