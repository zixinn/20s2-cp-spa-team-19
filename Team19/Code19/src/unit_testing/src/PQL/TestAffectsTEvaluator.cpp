...
TEST_CASE("AffectsTEvaluator evaluate known known") {
    ...
    bool b1 = AffectsTEvaluator::evaluate({}, Clause("Affects*", vector<string>{"6", "11"}, {}), tempResults1);
    unordered_map<string, vector<int>> expected1 = {};
    REQUIRE(b1);
    REQUIRE(tempResults1 == expected1);

    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsTEvaluator::evaluate({}, Clause("Affects*", vector<string>{"8", "10"}, {}), tempResults2);
...
TEST_CASE("AffectsTEvaluator evaluate known synonym") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsTEvaluator::evaluate({{"a", ASSIGN_}}, Clause("Affects*", vector<string>{"6", "a"}, {"a"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"a", vector<int>{9, 10}}};
    ...
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsTEvaluator::evaluate({{"n", PROGLINE_}}, Clause("Affects*", vector<string>{"3", "n"}, {"n"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {{"n", vector<int>{5}}};
    REQUIRE(b2);
    REQUIRE(tempResults2 == expected2);

    unordered_map<string, vector<int>> tempResults3;
    bool b3 = AffectsTEvaluator::evaluate({{"s", STMT_}}, Clause("Affects*", vector<string>{"4", "s"}, {"s"}), tempResults3);
...
TEST_CASE("AffectsTEvaluator evaluate known underscore") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsTEvaluator::evaluate({}, Clause("Affects*", vector<string>{"7", "_"}, {}), tempResults1);
    unordered_map<string, vector<int>> expected1 = {};
    REQUIRE(b1);
    REQUIRE(tempResults1 == expected1);

    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsTEvaluator::evaluate({}, Clause("Affects*", vector<string>{"1", "_"}, {}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("AffectsTEvaluator evaluate synonym known") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsTEvaluator::evaluate({{"a", ASSIGN_}}, Clause("Affects*", vector<string>{"a", "11"}, {"a"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"a", vector<int>{7, 9}}};
    ...
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsTEvaluator::evaluate({{"s", STMT_}}, Clause("Affects*", vector<string>{"s", "6"}, {"s"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("AffectsTEvaluator evaluate underscore known") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsTEvaluator::evaluate({}, Clause("Affects*", vector<string>{"_", "9"}, {}), tempResults1);
    unordered_map<string, vector<int>> expected1 = {};
    REQUIRE(b1);
    REQUIRE(tempResults1 == expected1);

    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsTEvaluator::evaluate({}, Clause("Affects*", vector<string>{"_", "8"}, {}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("AffectsTEvaluator evaluate synonym synonym") {
    setupAffectsT();
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsTEvaluator::evaluate({{"a", ASSIGN_}, {"n", PROGLINE_}}, Clause("Affects*", vector<string>{"a", "n"}, {"a", "n"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"a", vector<int>{2, 2, 3, 6, 6, 6, 7, 9}}, {"n", vector<int>{3, 5, 5, 9, 10, 11, 11, 11}}};
    ...
    setupAffectsT2();
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsTEvaluator::evaluate({{"a1", ASSIGN_}, {"a2", ASSIGN_}}, Clause("Affects*", vector<string>{"a1", "a2"}, {"a1", "a2"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
    ...
    setupAffectsT3();
    unordered_map<string, vector<int>> tempResults3;
    bool b3 = AffectsTEvaluator::evaluate({ {"s", STMT_} }, Clause("Affects", vector<string>{"s", "s"}, {"s"}), tempResults3);
...
TEST_CASE("AffectsTEvaluator evaluate synonym underscore") {
    setupAffectsT();
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsTEvaluator::evaluate({{"s", STMT_}}, Clause("Affects*", vector<string>{"s", "_"}, {"s"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"s", vector<int>{2, 3, 6, 7, 9}}};
    ...
    setupAffectsT2();
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsTEvaluator::evaluate({{"a", ASSIGN_}}, Clause("Affects*", vector<string>{"a", "_"}, {"a"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("AffectsTEvaluator evaluate underscore synonym") {
    setupAffectsT();
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsTEvaluator::evaluate({{"a", ASSIGN_}}, Clause("Affects*", vector<string>{"_", "a"}, {"a"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"a", vector<int>{3, 5, 9, 10, 11}}};
    ...
    setupAffectsT2();
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsTEvaluator::evaluate({{"n", PROGLINE_}}, Clause("Affects*", vector<string>{"_", "n"}, {"n"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("AffectsTEvaluator evaluate underscore underscore") {
    setupAffectsT();
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsTEvaluator::evaluate({}, Clause("Affects*", vector<string>{"_", "_"}, {}), tempResults1);
    unordered_map<string, vector<int>> expected1 = {};
    REQUIRE(b1);
    REQUIRE(tempResults1 == expected1);
    ...
    setupAffectsT2();
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsTEvaluator::evaluate({}, Clause("Affects*", vector<string>{"_", "_"}, {}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
