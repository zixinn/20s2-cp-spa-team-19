...
TEST_CASE("AffectsBipTEvaluator evaluate known known") {
  ...
  bool b1 = AffectsBipTEvaluator::evaluate(
      {}, Clause("AffectsBip*", vector<STRING>{"6", "5"}, {}, 2), tempResults1);
  unordered_map<STRING, vector<int>> expected1 = {};
  REQUIRE(b1);
  REQUIRE(tempResults1 == expected1);

  unordered_map<STRING, vector<int>> tempResults2;
  bool b2 = AffectsBipTEvaluator::evaluate(
  ...
  bool b3 = AffectsBipTEvaluator::evaluate(
      {}, Clause("AffectsBip*", vector<STRING>{"5", "7"}, {}, 2), tempResults3);
  unordered_map<STRING, vector<int>> expected3 = {};
  REQUIRE(b3);
  REQUIRE(tempResults3 == expected3);

  unordered_map<STRING, vector<int>> tempResults4;
  bool b4 = AffectsBipTEvaluator::evaluate(
      {}, Clause("AffectsBip*", vector<STRING>{"7", "4"}, {}, 2), tempResults4);
...
TEST_CASE("AffectsBipTEvaluator evaluate known synonym") {
  ...
  bool b1 = AffectsBipTEvaluator::evaluate(
      {{"a", ASSIGN_}},
      Clause("AffectsBip*", vector<STRING>{"5", "a"}, {"a"}, 1), tempResults1);
  REQUIRE_FALSE(b1);
  ...
  unordered_map<STRING, vector<int>> tempResults2;
  bool b2 = AffectsBipTEvaluator::evaluate(
      {{"s", STMT_}}, Clause("AffectsBip*", vector<STRING>{"7", "s"}, {"s"}, 1),
      tempResults2);
  ...
  bool b3 = AffectsBipTEvaluator::evaluate(
      {{"n", PROGLINE_}},
      Clause("AffectsBip*", vector<STRING>{"4", "n"}, {"n"}, 1), tempResults3);
...
TEST_CASE("AffectsBipTEvaluator evaluate synonym known") {
  ...
  bool b2 = AffectsBipTEvaluator::evaluate(
      {{"a", ASSIGN_}},
      Clause("AffectsBip*", vector<STRING>{"a", "5"}, {"a"}, 1), tempResults2);
  ...
  bool b3 = AffectsBipTEvaluator::evaluate(
      {{"n", PROGLINE_}},
      Clause("AffectsBip*", vector<STRING>{"n", "7"}, {"n"}, 1), tempResults3);
  unordered_set<int> actual3(tempResults3["n"].begin(),
                             tempResults3["n"].end());
...
TEST_CASE("AffectsBipTEvaluator evaluate underscore known") {
  ...
  unordered_map<STRING, vector<int>> tempResults1;
  bool b1 = AffectsBipTEvaluator::evaluate(
      {}, Clause("AffectsBip*", vector<STRING>{"_", "5"}, {}, 1), tempResults1);
  REQUIRE(b1);
  REQUIRE(tempResults1.empty());
...
TEST_CASE("AffectsBipTEvaluator evaluate synonym synonym") {
  ...
  bool b1 = AffectsBipTEvaluator::evaluate(
      {{"a", ASSIGN_}, {"s", STMT_}},
      Clause("AffectsBip*", vector<STRING>{"a", "s"}, {"a", "s"}, 0),
      tempResults1);
  ...
  bool b2 = AffectsBipTEvaluator::evaluate(
      ...
      Clause("AffectsBip*", vector<STRING>{"n", "n"}, {"n", "n"}, 0),
      tempResults2);
  REQUIRE_FALSE(b2);
  REQUIRE(tempResults2.empty());
}
...
TEST_CASE("AffectsBipTEvaluator evaluate synonym underscore") {
  ...
  bool b1 = AffectsBipTEvaluator::evaluate(
      {{"a", ASSIGN_}},
      Clause("AffectsBip*", vector<STRING>{"a", "_"}, {"a"}, 0), tempResults1);
  ...
  bool b2 = AffectsBipTEvaluator::evaluate(
      {{"n", PROGLINE_}},
      Clause("AffectsBip*", vector<STRING>{"n", "_"}, {"n"}, 0), tempResults2);
  REQUIRE_FALSE(b2);
  REQUIRE(tempResults2.empty());
}
...
TEST_CASE("AffectsBipTEvaluator evaluate underscore synonym") {
  ...
  bool b1 = AffectsBipTEvaluator::evaluate(
      {{"a", ASSIGN_}},
      Clause("AffectsBip*", vector<STRING>{"_", "a"}, {"a"}, 0), tempResults1);
  unordered_set<int> actual1(tempResults1["a"].begin(),
                             tempResults1["a"].end());
