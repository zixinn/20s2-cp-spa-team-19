#include "PQL/AffectsEvaluator.h"
#include "catch.hpp"
...
TEST_CASE("AffectsEvaluator evaluate known synonym") {
    setupAffects();

    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsEvaluator::evaluate({{"a", ASSIGN_}}, Clause("Affects", vector<string>{"6", "a"}, {"a"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"a", vector<int>{9, 10}}};
    ...
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsEvaluator::evaluate({{"n", PROGLINE_}}, Clause("Affects", vector<string>{"2", "n"}, {"n"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {{"n", vector<int>{3}}};
    REQUIRE(b2);
    REQUIRE(tempResults2 == expected2);

    unordered_map<string, vector<int>> tempResults3;
    bool b3 = AffectsEvaluator::evaluate({{"s", STMT_}}, Clause("Affects", vector<string>{"4", "s"}, {"s"}), tempResults3);
    unordered_map<string, vector<int>> expected3 = {};
    REQUIRE_FALSE(b3);
    REQUIRE(tempResults3 == expected3);
}

TEST_CASE("AffectsEvaluator evaluate known underscore") {
    setupAffects();
...
TEST_CASE("AffectsEvaluator evaluate synonym known") {
    setupAffects();

    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsEvaluator::evaluate({{"a", ASSIGN_}}, Clause("Affects", vector<string>{"a", "11"}, {"a"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"a", vector<int>{7, 9}}};
    ...
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsEvaluator::evaluate({{"s", STMT_}}, Clause("Affects", vector<string>{"s", "6"}, {"s"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}

TEST_CASE("AffectsEvaluator evaluate underscore known") {
    setupAffects();
...
TEST_CASE("AffectsEvaluator evaluate synonym synonym") {
    setupAffects();
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsEvaluator::evaluate({{"a", ASSIGN_}, {"n", PROGLINE_}}, Clause("Affects", vector<string>{"a", "n"}, {"n"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"a", vector<int>{2, 3, 6, 6, 7, 9}}, {"n", vector<int>{3, 5, 9, 10, 11, 11}}};
    ...
    set<pair<int, int>> expected1 = {{make_pair(2, 3), make_pair(3, 5), make_pair(6, 9),
                                      make_pair(6, 10), make_pair(7, 11), make_pair(9, 11)}};
    REQUIRE(b1);
    ...
    setupAffects2();
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsEvaluator::evaluate({{"a1", ASSIGN_}, {"a2", ASSIGN_}}, Clause("Affects", vector<string>{"a1", "a2"}, {"a1", "a2"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
    ...
    setupAffects3();
    unordered_map<string, vector<int>> tempResults3;
    bool b3 = AffectsEvaluator::evaluate({ {"a", ASSIGN_} }, Clause("Affects", vector<string>{"a", "a"}, {"a"}), tempResults3);
...
TEST_CASE("AffectsEvaluator evaluate synonym underscore") {
    setupAffects();
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsEvaluator::evaluate({{"s", STMT_}}, Clause("Affects", vector<string>{"s", "_"}, {"s"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"s", vector<int>{2, 3, 6, 7, 9}}};
    ...
    setupAffects2();
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsEvaluator::evaluate({{"a", ASSIGN_}}, Clause("Affects", vector<string>{"a", "_"}, {"a"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("AffectsEvaluator evaluate underscore synonym") {
    setupAffects();
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = AffectsEvaluator::evaluate({{"a", ASSIGN_}}, Clause("Affects", vector<string>{"_", "a"}, {"a"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"a", vector<int>{3, 5, 9, 10, 11}}};
    ...
    setupAffects2();
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = AffectsEvaluator::evaluate({{"n", PROGLINE_}}, Clause("Affects", vector<string>{"_", "n"}, {"n"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
