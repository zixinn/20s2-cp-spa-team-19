...
TEST_CASE("NextTEvaluator evaluate known synonym") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = NextTEvaluator::evaluate({ {"w", WHILE_} }, Clause("Next*", vector<string>{"1", "w"}, {"w"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = { {"w", vector<int>{2, 5}} };
    ...
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = NextTEvaluator::evaluate({ {"a", ASSIGN_} }, Clause("Next*", vector<string>{"6", "a"}, {"a"}), tempResults2);
//    unordered_map<string, vector<int>> expected2 = { {"a", vector<int>{7, 8, 11}} };
    ...
    unordered_map<string, vector<int>> tempResults3;
    bool b3 = NextTEvaluator::evaluate({ {"s", STMT_} }, Clause("Next*", vector<string>{"9", "s"}, {"s"}), tempResults3);
//    unordered_map<string, vector<int>> expected3 = { {"s", vector<int>{5, 6, 10, 7, 8, 11, 12, 9, 13, 14}} };
    ...
    unordered_map<string, vector<int>> tempResults4;
    bool b4 = NextTEvaluator::evaluate({ {"a", ASSIGN_} }, Clause("Next*", vector<string>{"13", "a"}, {"a"}), tempResults4);
    unordered_map<string, vector<int>> expected4 = {};
    REQUIRE_FALSE(b4);
    REQUIRE(tempResults4 == expected4);
}
...
TEST_CASE("NextTEvaluator evaluate synonym known") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = NextTEvaluator::evaluate({ {"ifs", IF_} }, Clause("Next*", vector<string>{"ifs", "12"}, {"ifs"}), tempResults1);
    unordered_map<string, vector<int>> expected1 = { {"ifs", vector<int>{6, 10}} };
    REQUIRE(b1);
    REQUIRE(tempResults1 == expected1);

    unordered_map<string, vector<int>> tempResults2;
    bool b2 = NextTEvaluator::evaluate({ {"r", READ_} }, Clause("Next*", vector<string>{"r", "14"}, {"r"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = { {"r", vector<int>{12, 13}} };
    REQUIRE(b2);
    REQUIRE(tempResults2 == expected2);

    unordered_map<string, vector<int>> tempResults3;
    bool b3 = NextTEvaluator::evaluate({ {"p", PROGLINE_} }, Clause("Next*", vector<string>{"p", "1"}, {"p"}), tempResults3);
    unordered_map<string, vector<int>> expected3 = {};
    REQUIRE_FALSE(b3);
    REQUIRE(tempResults3 == expected3);
}
...
TEST_CASE("NextTEvaluator evaluate synonym synonym") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = NextTEvaluator::evaluate({ {"a", ASSIGN_}, {"c", CALL_} }, Clause("Next*", vector<string>{"a", "c"}, {"a", "c"}), tempResults1);
    ...
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = NextTEvaluator::evaluate({ {"pn", PRINT_}, {"r", READ_} }, Clause("Next*", vector<string>{"pn", "r"}, {"pn", "r"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);

    unordered_map<string, vector<int>> tempResults3;
    bool b3 = NextTEvaluator::evaluate({ {"n", PROGLINE_} }, Clause("Next*", vector<string>{"n", "n"}, {"n", "n"}), tempResults3);
...
TEST_CASE("NextTEvaluator evaluate synonym underscore") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = NextTEvaluator::evaluate({ {"w", WHILE_} }, Clause("Next*", vector<string>{"w", "_"}, {"w"}), tempResults1);
    unordered_set<int> actual1(tempResults1["w"].begin(), tempResults1["w"].end());
    unordered_set<int> expected1{ 2, 5 };
    REQUIRE(b1);
    REQUIRE(actual1 == expected1);
    ...
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = NextTEvaluator::evaluate({ {"pn", PRINT_} }, Clause("Next*", vector<string>{"pn", "_"}, {"pn"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("NextTEvaluator evaluate underscore synonym") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = NextTEvaluator::evaluate({ {"a", ASSIGN_} }, Clause("Next*", vector<string>{"_", "a"}, {"a"}), tempResults1);
    ...
    setupNextT1();
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = NextTEvaluator::evaluate({ {"p", PRINT_} }, Clause("Next*", vector<string>{"_", "p"}, {"p"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
