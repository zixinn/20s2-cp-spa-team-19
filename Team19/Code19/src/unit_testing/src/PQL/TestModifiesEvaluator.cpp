...
TEST_CASE("ModifiesEvaluator evaluate stmt known synonym") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = ModifiesEvaluator::evaluate({{"v", VARIABLE_}}, Clause("Modifies", vector<string>{"13", "v"}, {"v"}), tempResults1);
    unordered_map<string, vector<int>> expected1 = {{"v", vector<int>{2}}};
    REQUIRE(b1);
    REQUIRE(tempResults1 == expected1);

    unordered_map<string, vector<int>> tempResults2;
    bool b2 = ModifiesEvaluator::evaluate({{"v", VARIABLE_}}, Clause("Modifies", vector<string>{"4", "v"}, {"v"}), tempResults2);
...
TEST_CASE("ModifiesEvaluator evaluate stmt synonym known") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = ModifiesEvaluator::evaluate({{"s", STMT_}}, Clause("Modifies", vector<string>{"s", "\"cenX\""}, {"s"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"s", vector<int>{10, 5, 12, 7, 2}}};
    ...
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = ModifiesEvaluator::evaluate({{"w", WHILE_}}, Clause("Modifies", vector<string>{"w", "\"count\""}, {"w"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {{"w", vector<int>{5}}};
    REQUIRE(b2);
    REQUIRE(tempResults2 == expected2);

    unordered_map<string, vector<int>> tempResults3;
    bool b3 = ModifiesEvaluator::evaluate({{"ifs", IF_}}, Clause("Modifies", vector<string>{"ifs", "\"normSq\""}, {"ifs"}), tempResults3);
...
TEST_CASE("ModifiesEvaluator evaluate stmt synonym synonym") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = ModifiesEvaluator::evaluate({{"ifs", IF_}, {"v", "variable"}}, Clause("Modifies", vector<string>{"ifs", "v"}, {"ifs", "v"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"ifs", vector<int>{10, 10, 10}}, {"v", vector<int>{2, 1, 5}}};
    ...
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = ModifiesEvaluator::evaluate({{"r", READ_}, {"v", VARIABLE_}}, Clause("Modifies", vector<string>{"r", "v"}, {"r", "v"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("ModifiesEvaluator evaluate stmt synonym underscore") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = ModifiesEvaluator::evaluate({{"a", ASSIGN_}}, Clause("Modifies", vector<string>{"a", "_"}, {"a"}), tempResults1);
//    unordered_map<string, vector<int>> expected1 = {{"a", vector<int>{1, 2, 3, 6, 7, 8, 11, 12, 13, 14}}};
    ...
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = ModifiesEvaluator::evaluate({{"r", READ_}}, Clause("Modifies", vector<string>{"r", "_"}, {"r"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("ModifiesEvaluator evaluate proc known synonym") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = ModifiesEvaluator::evaluate({{"v", VARIABLE_}}, Clause("Modifies", vector<string>{"\"computeCentroid\"", "v"}, {"v"}), tempResults1);
...
TEST_CASE("ModifiesEvaluator evaluate proc synonym known") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = ModifiesEvaluator::evaluate({{"p", PROCEDURE_}}, Clause("Modifies", vector<string>{"p", "\"flag\""}, {"p"}), tempResults1);
    unordered_map<string, vector<int>> expected1 = {{"p", vector<int>{0}}};
    REQUIRE(b1);
    REQUIRE(tempResults1 == expected1);

    unordered_map<string, vector<int>> tempResults2;
    bool b2 = ModifiesEvaluator::evaluate({{"p", PROCEDURE_}}, Clause("Modifies", vector<string>{"p", "\"z\""}, {"p"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = {};
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("ModifiesEvaluator evaluate proc synonym synonym") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = ModifiesEvaluator::evaluate({{"p", PROCEDURE_}, {"v", VARIABLE_}}, Clause("Modifies", vector<string>{"p", "v"}, {"p", "v"}), tempResults1);
...
TEST_CASE("ModifiesEvaluator evaluate proc synonym underscore") {
    ...
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = ModifiesEvaluator::evaluate({{"p", PROCEDURE_}}, Clause("Modifies", vector<string>{"p", "_"}, {"p"}), tempResults1);
    unordered_map<string, vector<int>> expected1 = {{"p", vector<int>{0}}};
    REQUIRE(b1);
    REQUIRE(tempResults1 == expected1);
}
