...
TEST_CASE("CallsEvaluator evaluate underscore underscore (when proc calls exists)") {
    ...
    bool b1 = CallsEvaluator::evaluate({ }, Clause("Calls", vector<STRING>{"_", "_"}, {}, 0),
                                       tempResults1);
...
TEST_CASE("CallsEvaluator evaluate known known") {
    ...
    // Calls ("proc2", "proc3")
    unordered_map<STRING, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({}, Clause("Calls", vector<STRING>{"\"proc2\"", "\"proc3\""}, {},
                                                  2), tempResults1);
    unordered_map<STRING, vector<int>> expected1 = {};
    REQUIRE(b1);
    REQUIRE(tempResults1 == expected1);
    ...
    bool b2 = CallsEvaluator::evaluate({}, Clause("Calls", vector<STRING>{"\"proc8\"", "\"proc0\""}, {},
                                                  2), tempResults2);
...
TEST_CASE("CallsEvaluator evaluate known synonym") {
    ...
    // Calls ("proc2", p)
    unordered_map<STRING, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls",
                                                                     vector<STRING>{"\"proc2\"", "p"}, {"p"}, 1), tempResults1);
    ...
    // Calls ("proc3", p)
    unordered_map<STRING, vector<int>> tempResults2;
    bool b2 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls",
                                                                     vector<STRING>{"\"proc3\"", "p"}, {"p"}, 1), tempResults2);
    unordered_map<STRING, vector<int>> expected2 = { };
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("CallsEvaluator evaluate synonym known") {
    ...
    unordered_map<STRING, vector<int>> tempResults2;
    bool b2 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls",
                                                                     vector<STRING>{"p", "\"proc7\""}, {"p"}, 1), tempResults2);
    ...
    bool b3 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls",
                                                                     vector<STRING>{"p", "\"proc4\""}, {"p"}, 1), tempResults3);
...
TEST_CASE("CallsEvaluator evaluate known underscore") {
    ...
    // Calls ("proc7", _)
    unordered_map<STRING, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({ }, Clause("Calls",
                                                   vector<STRING>{"\"proc7\"", "_"}, {}, 1), tempResults1);
    unordered_map<STRING, vector<int>> expected1 = { };
    REQUIRE(b1);
    REQUIRE(tempResults1 == expected1);
    ...
    // Calls ("proc3", _)
    unordered_map<STRING, vector<int>> tempResults2;
    bool b2 = CallsEvaluator::evaluate({ }, Clause("Calls",
                                                   vector<STRING>{"\"proc3\"", "_"}, {}, 1), tempResults2);
    unordered_map<STRING, vector<int>> expected2 = { };
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("CallsEvaluator evaluate underscore known") {
    ...
    unordered_map<STRING, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({ }, Clause("Calls",
                                                   vector<STRING>{"_", "\"proc1\""}, {}, 1), tempResults1);
    unordered_map<STRING, vector<int>> expected1 = { };
    REQUIRE(b1);
    REQUIRE(tempResults1 == expected1);
    ...
    unordered_map<STRING, vector<int>> tempResults2;
    bool b2 = CallsEvaluator::evaluate({ }, Clause("Calls",
                                                   vector<STRING>{"_", "\"proc4\""}, {}, 1), tempResults2);
    unordered_map<STRING, vector<int>> expected2 = { };
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("CallsEvaluator evaluate synonym synonym") {
    ...
    // Calls (p, p1)
    unordered_map<STRING, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({ {"p", PROCEDURE_}, {"p1", PROCEDURE_} },
                                       Clause("Calls", vector<STRING>{"p", "p1"},
                                              {"p", "p1"}, 0), tempResults1);
    ...
    set<pair<int, int>> expected1 = { {make_pair(0, 1), make_pair(1, 2), make_pair(1, 3), make_pair(2, 3),
                                              make_pair(4, 1), make_pair(4, 5), make_pair(5, 7), make_pair(6, 7),
                                              make_pair(8, 7), make_pair(7, 0)} };
...
TEST_CASE("CallsEvaluator evaluate underscore synonym") {
    ...
    unordered_map<STRING, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls",
                                                                     vector<STRING>{"_", "p"}, {"p"}, 0), tempResults1);
