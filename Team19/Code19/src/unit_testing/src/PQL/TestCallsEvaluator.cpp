...
TEST_CASE("CallsEvaluator evaluate known synonym") {
    ...
    // Calls ("proc2", p)
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls", vector<string>{"\"proc2\"", "p"}), tempResults1);
    ...
    // Calls ("proc3", p)
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls", vector<string>{"\"proc3\"", "p"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = { };
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("CallsEvaluator evaluate synonym known") {
    ...
    bool b3 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls", vector<string>{"p", "\"proc4\""}), tempResults3);
...
TEST_CASE("CallsEvaluator evaluate synonym synonym") {
    ...
    // Calls (p, p1)
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({ {"p", PROCEDURE_}, {"p1", PROCEDURE_} }, Clause("Calls", vector<string>{"p", "p1"}), tempResults1);
...
TEST_CASE("CallsEvaluator evaluate underscore synonym") {
    ...
    // Calls (_, p)
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls", vector<string>{"_", "p"}), tempResults1);
    ...
    // Calls (_, p)
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls", vector<string>{"_", "p"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = { };
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("CallsEvaluator evaluate synonym underscore") {
    ...
    // Calls (p, _)
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls", vector<string>{"p", "_"}), tempResults1);
    unordered_set<int> actual1(tempResults1["p"].begin(), tempResults1["p"].end());
    ...
    // Calls (p, _)
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls", vector<string>{"p", "_"}), tempResults2);
    unordered_map<string, vector<int>> expected2 = { };
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
