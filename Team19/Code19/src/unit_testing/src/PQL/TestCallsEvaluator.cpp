...
TEST_CASE("CallsEvaluator evaluate underscore underscore (when proc calls exists)") {
    ...
    bool b1 = CallsEvaluator::evaluate({ }, Clause("Calls", vector<string>{"_", "_"}, {}, 0), tempResults1);
...
TEST_CASE("CallsEvaluator evaluate known known") {
    ...
    // Calls ("proc2", "proc3")
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({}, Clause("Calls", vector<string>{"\"proc2\"", "\"proc3\""}, {}, 2), tempResults1);
    unordered_map<string, vector<int>> expected1 = {};
    REQUIRE(b1);
    REQUIRE(tempResults1 == expected1);
    ...
    bool b2 = CallsEvaluator::evaluate({}, Clause("Calls", vector<string>{"\"proc8\"", "\"proc0\""}, {}, 2), tempResults2);
...
TEST_CASE("CallsEvaluator evaluate known synonym") {
    ...
    // Calls ("proc2", p)
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls", vector<string>{"\"proc2\"", "p"}, {"p"}, 1), tempResults1);
    ...
    // Calls ("proc3", p)
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls", vector<string>{"\"proc3\"", "p"}, {"p"}, 1), tempResults2);
    unordered_map<string, vector<int>> expected2 = { };
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("CallsEvaluator evaluate synonym known") {
    ...
    // Calls (p, "proc7")
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls", vector<string>{"p", "\"proc7\""}, {"p"}, 1), tempResults2);
    ...
    bool b3 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls", vector<string>{"p", "\"proc4\""}, {"p"}, 1), tempResults3);
...
TEST_CASE("CallsEvaluator evaluate known underscore") {
    ...
    // Calls ("proc7", _)
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({ }, Clause("Calls", vector<string>{"\"proc7\"", "_"}, {}, 1), tempResults1);
    unordered_map<string, vector<int>> expected1 = { };
    REQUIRE(b1);
    REQUIRE(tempResults1 == expected1);
    ...
    // Calls ("proc3", _)
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = CallsEvaluator::evaluate({ }, Clause("Calls", vector<string>{"\"proc3\"", "_"}, {}, 1), tempResults2);
    unordered_map<string, vector<int>> expected2 = { };
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("CallsEvaluator evaluate underscore known") {
    ...
    // Calls (_, "proc1")
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({ }, Clause("Calls", vector<string>{"_", "\"proc1\""}, {}, 1), tempResults1);
    unordered_map<string, vector<int>> expected1 = { };
    REQUIRE(b1);
    REQUIRE(tempResults1 == expected1);
    ...
    // Calls (_, "proc4")
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = CallsEvaluator::evaluate({ }, Clause("Calls", vector<string>{"_", "\"proc4\""}, {}, 1), tempResults2);
    unordered_map<string, vector<int>> expected2 = { };
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("CallsEvaluator evaluate synonym synonym") {
    ...
    // Calls (p, p1)
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({ {"p", PROCEDURE_}, {"p1", PROCEDURE_} }, Clause("Calls", vector<string>{"p", "p1"}, {"p", "p1"}, 0), tempResults1);
...
TEST_CASE("CallsEvaluator evaluate underscore synonym") {
    ...
    // Calls (_, p)
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls", vector<string>{"_", "p"}, {"p"}, 0), tempResults1);
    ...
    // Calls (_, p)
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls", vector<string>{"_", "p"}, {"p"}, 0), tempResults2);
    unordered_map<string, vector<int>> expected2 = { };
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
...
TEST_CASE("CallsEvaluator evaluate synonym underscore") {
    ...
    // Calls (p, _)
    unordered_map<string, vector<int>> tempResults1;
    bool b1 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls", vector<string>{"p", "_"}, {"p"}, 0), tempResults1);
    unordered_set<int> actual1(tempResults1["p"].begin(), tempResults1["p"].end());
    ...
    // Calls (p, _)
    unordered_map<string, vector<int>> tempResults2;
    bool b2 = CallsEvaluator::evaluate({ {"p", PROCEDURE_} }, Clause("Calls", vector<string>{"p", "_"}, {"p"}, 0), tempResults2);
    unordered_map<string, vector<int>> expected2 = { };
    REQUIRE_FALSE(b2);
    REQUIRE(tempResults2 == expected2);
}
